...
for path in ROOT.rglob('*.html'):
    ...
    text = text.replace('href="/assets/premium.css?v=1"', f'href="/assets/premium.css?v={ASSET_VERSION}"')
    text = text.replace('src="/assets/premium.js?v=1"', f'src="/assets/premium.js?v={ASSET_VERSION}"')
