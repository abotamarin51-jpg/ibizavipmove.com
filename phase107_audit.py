...
for path in CONTACTS:
    ...
    if html.count('/assets/phase107.js?v=107')!=1:
        raise SystemExit(f'Phase 107 script cardinality mismatch: {path}')
...
print('PASS: Phase 107 audit — five qualified private-brief forms classify buyer role and Ibiza stay area while analytics remain PII-free and SEO/accessibility stay unchanged')
